...
CSRF_TRUSTED_ORIGINS = ['http://weasy.azurewebsites.net', 'http://127.0.0.1', 'http://10.0.0.95', 'http://image.weasy.net', 'https://image.weasy.net',]
'''
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/site/wwwroot/logfile.log',
        },
    },
    'root': {
        'handlers': ['file'],
